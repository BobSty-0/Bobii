...
namespace Bobii.src.FilterLink.EntityFramework
{
    class FilterLinkUserGuildHelper
    {
        ...
        public static async Task AddWhiteListUserToGuild(ulong guildid, ulong userId)
        {
            ...
            {
                await Handler.HandlingService.BobiiHelper.WriteToConsol("FilterLink", true, "AddWhiteListUserToGuild", exceptionMessage: ex.Message);
            }
        }
        ...
        public static async Task RemoveWhiteListUserFromGuild(ulong guildid, ulong userId)
        {
            ...
            {
                await Handler.HandlingService.BobiiHelper.WriteToConsol("FilterLink", true, "RemoveWhiteListUserFromGuild", exceptionMessage: ex.Message);
            }
        }
        ...
        public static async Task<List<filterlinkuserguild>> GetUsers(ulong guildId)
        {
            ...
            {
                await Handler.HandlingService.BobiiHelper.WriteToConsol("FilterLink", true, "GetUsers", exceptionMessage: ex.Message);
                return null;
            }
        }
        ...
        public static async Task<bool> IsUserOnWhitelistInGuild(ulong guildId, ulong userId)
        {
            ...
            {
                await Handler.HandlingService.BobiiHelper.WriteToConsol("FilterLink", true, "IsUserOnWhitelistInGuild", exceptionMessage: ex.Message);
                return false;
            }
        }
        #endregion
