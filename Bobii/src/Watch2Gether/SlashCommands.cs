...
namespace Bobii.src.Watch2Gether
{
    class SlashCommands
    {
        ...
        public static async Task W2GStart(SlashCommandParameter parameter)
        {
            ...
            if (Bobii.CheckDatas.CheckUserPermission(parameter, "W2GStart").Result ||
                Bobii.CheckDatas.CheckDiscordChannelIDFormat(parameter, voiceChannelID, "W2GStart", true).Result ||
