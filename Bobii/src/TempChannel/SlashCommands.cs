...
namespace Bobii.src.TempChannel
{
    class SlashCommands
    {
        ...
        public static async Task TCAdd(SlashCommandParameter parameter)
        {
            ...
            try
            {
                await EntityFramework.CreateTempChannelsHelper.AddCC(parameter.GuildID, tempChannelName, ulong.Parse(createChannelID), channelSize, finalDelay);
                await parameter.Interaction.RespondAsync(null, new Embed[] { Bobii.Helper.CreateEmbed(parameter.Interaction,
                ...
                await Handler.HandlingService.BobiiHelper.WriteToConsol(src.Bobii.Actions.SlashComms, false, nameof(TCAdd), parameter, createChannelID: ulong.Parse(createChannelID),
            ...
            catch (Exception ex)
            {
                ...
                await Handler.HandlingService.BobiiHelper.WriteToConsol(src.Bobii.Actions.SlashComms, true, nameof(TCAdd), parameter, createChannelID: ulong.Parse(createChannelID),
        ...
        public static async Task TCUpdate(SlashCommandParameter parameter)
        {
            ...
            if (createVoiceChannel == Bobii.Helper.GetContent("C096", parameter.Language).Result.ToLower())
            {
                await parameter.Interaction.RespondAsync(null, new Embed[] { Bobii.Helper.CreateEmbed(parameter.Interaction,
                    ...
                    ephemeral: true);
                await Handler.HandlingService.BobiiHelper.WriteToConsol(src.Bobii.Actions.SlashComms, true, nameof(TCUpdate), parameter, message: "Could not find any channels");
                return;
            }
            ...
            try
            {
                ...
                await Handler.HandlingService.BobiiHelper.WriteToConsol(src.Bobii.Actions.SlashComms, false, nameof(TCUpdate), parameter, createChannelID: ulong.Parse(createChannelID),
            ...
            catch (Exception ex)
            {
                await parameter.Interaction.RespondAsync(null, new Embed[] { Bobii.Helper.CreateEmbed(parameter.Interaction,
                    ...
                    Bobii.Helper.GetCaption("C038", parameter.Language).Result).Result }, ephemeral: true);
                await Handler.HandlingService.BobiiHelper.WriteToConsol(src.Bobii.Actions.SlashComms, true, nameof(TCUpdate), parameter, createChannelID: ulong.Parse(createChannelID),
        ...
        public static async Task TCRemove(SlashCommandParameter parameter)
        {
            ...
            try
            {
                ...
                await Handler.HandlingService.BobiiHelper.WriteToConsol(src.Bobii.Actions.SlashComms, false, nameof(TCRemove), parameter, createChannelID: ulong.Parse(createChannelID),
            ...
            catch (Exception ex)
            {
                await parameter.Interaction.RespondAsync(null, new Embed[] { Bobii.Helper.CreateEmbed(parameter.Interaction,
                    ...
                    Bobii.Helper.GetCaption("C038", parameter.Language).Result).Result }, ephemeral: true);
                await Handler.HandlingService.BobiiHelper.WriteToConsol(src.Bobii.Actions.SlashComms, true, nameof(TCRemove), parameter, createChannelID: ulong.Parse(createChannelID),
