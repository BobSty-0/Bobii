    ...
    class SlashCommands
    {
        public static async Task StealEmojiUrl(SlashCommandParameter parameter)
        {
            ...
            try
            {
                ...
                await Handler.HandlingService.BobiiHelper.WriteToConsol(src.Bobii.Actions.SlashComms, false, "StealEmojiUrl", parameter, emojiString: emoteUrl, message: "Sucessfully added Emoji");
            ...
            catch (Exception ex)
            {
                ...
                await Handler.HandlingService.BobiiHelper.WriteToConsol(src.Bobii.Actions.SlashComms, true, "StealEmojiUrl", parameter, emojiString: emoteUrl, message: "Failed to add Emoji", exceptionMessage: ex.Message);
            }
        }
