            ...
            if (parsedArg.Data.Values != null)
            {
                ...
                switch (commandName)
                {
                    case "temp-channel-help-selectmenuoption":
                        ...
                        await Bobii.Helper.WriteToConsol("MessageCom", false, "MessageComponentHandler, Help", new Entities.SlashCommandParameter() { Guild = parsedUser.Guild, GuildUser = parsedUser},
                    ...
                    case "how-to-cereate-temp-channel-guide":
                        ...
                        await Bobii.Helper.WriteToConsol("MessageCom", false, "MessageComponentHandler, Guide", new Entities.SlashCommandParameter() { Guild = parsedUser.Guild, GuildUser = parsedUser },
