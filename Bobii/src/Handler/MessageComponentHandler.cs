                    ...
                    switch (parsedArg.Data.CustomId)
                    {
                        ...
                        case "temp-interface-name":
                            ...
                            var mb = new ModalBuilder()
                                ...
                                .AddTextInput(GeneralHelper.GetContent("C340", parameter.Language).Result, "new_status", TextInputStyle.Short, required: false, maxLength: 50, value: parameter.GuildUser.VoiceChannel.Status);
                            await parameter.Interaction.RespondWithModalAsync(mb.Build());
                            break;
