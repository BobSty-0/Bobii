    ...
    class SlashCommands
    {
        ...
        public static async Task Backup(SlashCommandParameter parameter)
        {
            try
            {
                ...
                await Handler.HandlingService.BobiiHelper.WriteToConsol(src.Bobii.Actions.SlashComms, false, nameof(Backup), parameter, message: "Successfully used /backup");
            }
            catch (Exception ex)
            {
                await Handler.HandlingService.BobiiHelper.WriteToConsol(src.Bobii.Actions.SlashComms, true, nameof(Backup), parameter, message: "/backup could not be used", exceptionMessage: ex.Message);
            }
        }
        ...
        public static async Task Refresh(SlashCommandParameter parameter)
        {
            try
            {
                ...
                await Handler.HandlingService.BobiiHelper.WriteToConsol(src.Bobii.Actions.SlashComms, false, "Refresh", parameter, message: "Successfully used /refresh");
            }
            catch (Exception ex)
            {
                await Handler.HandlingService.BobiiHelper.WriteToConsol(src.Bobii.Actions.SlashComms, true, "Refresh", parameter, message: "/refresh could not be used", exceptionMessage: ex.Message);
            }
        }
        ...
        public static async Task ServerCount(SlashCommandParameter parameter)
        {
            try
            {
                ...
                await Handler.HandlingService.BobiiHelper.WriteToConsol(src.Bobii.Actions.SlashComms, false, "ServerCount", parameter, message: "/servercount successfully used");
            }
            catch (Exception ex)
            {
                await Handler.HandlingService.BobiiHelper.WriteToConsol(src.Bobii.Actions.SlashComms, true, "ServerCount", parameter, message: "/servercount could not be used", exceptionMessage: ex.Message);
            }
        }
        #endregion
    }
